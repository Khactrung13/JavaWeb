...
<body style="background: aliceblue; width: 1410px;">
	...
	<form action="adminthemsanpham" method="post" enctype= "multipart/form-data"
		...
		<p
			...
			ảnh</p>
		 <input style="margin-bottom: 5px; margin-left: 150px;" type ="file" name="hinhanh" >
		...
		<p style="width: 80%; margin-left: 150px;">
			<textarea style="margin-left: 150px; width: 80%;" rows="10"
				cols="123" name="tomtat" id="editor1"></textarea>
		</p>
		<p
		...
		<p style="width: 80%; margin-left: 150px;">
			<textarea style="margin-left: 150px; width: 80%;" rows="10"
				cols="123" name="noidung" id="editor"></textarea>
		</p>
		...
		<select name="iddanhmuc"
		 ...
		 <br> <input
			...
			name="them" type="submit" value="Thêm sản phẩm ">
		<p
	...
	<table border="1"
		...
		NumberFormat currencyVN = NumberFormat.getCurrencyInstance(localvn);
					...
					%>
		<tr>
			<td style="text-align: center;"><%=sp.getId()%></td>
			<td style="text-align: center;"><%=sp.getMa()%></td>
			<td style="text-align: center;"><%=sp.getTensp()%></td>
			<td style="text-align: center;"><%=currencyVN.format(sp.getGia())%></td>
			<td style="text-align: center;"><%=sp.getSoluong()%></td>
			<td><img style="width: 100%; height: 150px;"
				src="files/<%=sp.getHinhanh()%>"></td>
			<td style="text-align: center;"><%=sp.getTomtat()%></td>
			<td style="text-align: center;"><%=sp.getNoidung()%></td>
			<td style="text-align: center;"><%=sp.getIddanhmuc()%></td>
			<td style="text-align: center;"><a style="margin-right: 20px;"
				href="adminsuasanpham?id=<%=sp.getId()%>">Sửa</a> <a
				style="color: red;" href="adminxoasanpham?id=<%=sp.getId()%>">Xoá</a></td>
		</tr>
		<%
					}
					%>
