    ...
    <div class="container" id="container" style="height: 550px;">
      <div class="form-container sign-up-container">
            <form action="dangnhap" method="post">
                ...
                <a href="dangnhap">Forgot your password?</a>
        ...
        <div class="form-container sign-in-container">
            <form action="dangky" method="post">
                ...
                <input type="text" placeholder="Name" name="ten">
                 <input type="text" placeholder="Address" name="diachi">
                  <input type="text" placeholder="PhoneNumber" name="sdt">
                <input type="email" placeholder="Email" name="email">
                <input type="password" placeholder="Password" name="pass">
                 <input type="password" placeholder="Repeat Password" name="pass1">
