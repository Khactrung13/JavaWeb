...
<body
	...
	<div id="main">
		...
		<div class="maincontent"
			...
			<h2 style="margin-top: 20px;margin-left: 20px;">Danh mục : <%=request.getAttribute("timkiem1")%></h2>
...
<%} %>
	...
	<a style="margin-right: 5px;color: black;font-weight: bold;" href="timkiem?trang=<%=i%>&id=<%=id%>&sp=<%=tukhoa%>"><%=i%></a>
	<%} %>
	</form>
