...
<body style="background: aliceblue;    width: 1410px;">
	...
	<form style="
        margin-left: 1100px;
    padding-top: 5px;"class="form-inline my-2 my-lg-0" action="adminloaicontroller" method="POST">
	...
	<form action="adminthemdanhmuc" method="POST"
		...
		<p
			style="margin-bottom: 5px; margin-top: 20px; margin-left: 150px; font-size: 25px; font-weight: bold;">Mã
			loại</p>
		<input style="margin-left: 150px; margin-bottom: 5px; width: 80%;"
			type="text" placeholder="Mã loại .... " name="maloai">
		<p
			style="margin-bottom: 5px; margin-left: 150px; font-size: 25px; font-weight: bold;">Tên
			loại</p>
		<input style="margin-left: 150px; margin-bottom: 5px; width: 80%;"
			type="text" placeholder="Tên loại .... " name="tenloai"> <br>
		<input
			style="margin-left: 150px; margin-bottom: 25px; width: 80%; background: darkkhaki; font-size: 20px; font-weight: bold; margin-top: 20px;"
			name="them" type="submit" value="Thêm danh mục sản phẩm ">
		  <p style="    color: red;
    font-weight: bold;
    width: 100%;
    text-align: center;">${mess}</p>
	</form>
	<%
    ...
    width: 100%;
    text-align: center;
    margin-top: 20px;">Không tìm thấy tên danh mục !!!!!</p>
	<%}else{ %>
	<table border="1"
		...
		<tr>
			...
			<td style="text-align: center;"><a style="margin-right: 20px;"
				href="adminsuadanhmuc?id=<%=loai.getId()%>">Sửa</a> <a style="    color: red;"
